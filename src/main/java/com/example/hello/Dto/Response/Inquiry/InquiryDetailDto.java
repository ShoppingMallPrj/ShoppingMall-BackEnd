package com.example.hello.Dto.Response.Inquiry;
...
public class InquiryDetailDto {
    ...
    //Entity에서 dto 변환
    public static InquiryDetailDto from(InquiryEntity inquiryEntity, ModelMapper modelMapper){

        InquiryDetailDto inquiryDetailDto = modelMapper.map(inquiryEntity, InquiryDetailDto.class);
        inquiryDetailDto.setUserId(inquiryEntity.getUserEntity().getUserId());
        inquiryDetailDto.setUserEmail(inquiryEntity.getUserEntity().getUserEmail());
