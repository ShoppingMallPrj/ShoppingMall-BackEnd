...
import com.example.mall.Service.GoogleLoginService;
import com.example.mall.Service.KakaoLoginService;
...
public class LoginController {
    ...
    @PostMapping("/email")
    public LoginDto emailLogin(@RequestBody com.example.mall.Dto.Request.User.LoginDto loginDto) {
